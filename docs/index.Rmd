...
* The generative algorithm will be of recurrent nature, where a snippet of monophonic midi track consisting of n number of quarter or 1/16th notes will be fed at a time into a neural network of input matrix dimension 129 by n.


* This neural network will then output a matrix 129 by 1, which will be compared to the immediate next quarter or 1/16th note of the input for back propagation.  Thus, the model would take n quarter or 1/16th notes as input to predict the immediate next note.
...
.center[<img src="http://cms.brangerbriz.com/img/assetsFile/images/d7137f62cbeafcdc550298d39ed6c585" height="500px">]
